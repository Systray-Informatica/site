	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 col-md-4 col-lg-4">
				...
				<br>
				<div class="caption">
					<div id="p1">Ser uma referência como uma empresa que fornece soluções para facilitar a vida das pessoas e que as pessoas tenham orgulho de trabalhar.</div>
				</div>
			</div>
			<div class="col-sm-6 col-md-4 col-lg-4">
				<div align="center">
					<img src="app/img/visao.jpg" class="mb-4">
				</div>
				<br>
				<div class="caption">
					<div id="p1">Queremos entregar soluções que ajudem a facilitar a vida das pessoas.</div>
				</div>
			</div>
			<div class="col-sm-6 col-md-4 col-lg-4">
				<div align="center">
					<img src="app/img/valores.jpg" class="mb-4">
				</div>
				<br>
				<div class="caption">
