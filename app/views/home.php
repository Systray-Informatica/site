...
<div id="middle">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail">
					<img src="app/img/condominio.png" width="200px" class="img-thumbnail">
			...
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail">
					<img src="app/img/logo_systray.png" width="230px" class="img-thumbnail">
					<div class="caption">
			...
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail">
					<img src="app/img/professor.png" width="185px" class="img-thumbnail">
					<div class="caption">
	...
	<div id="clientes">
		<div class="container">
			<div class="center"><span style="color:antiquewhite;font-family:Verdana, Geneva, Tahoma, sans-serif; font-size: 30px">CLIENTES</span></div><br>
			<!--<div class="row">
