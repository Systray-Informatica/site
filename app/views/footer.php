<footer>
	<div class="container">
		<div class="row">
			<div class="col-md-2"><a href="#"><img id="logo" src="app/img/logo_systray_lado.png" width="80px"></a></div>
		...
		<div class="row">
			<div class="col-md-12">
				<p style="font-size:12px">© 2020 Systray Informatica | Todos os direitos reservados. Construido por <a href="systrayinformatica.com.br">Systray Informática</a>.</p>
			</div>
		</div>
	</div>
	<!-- jQuery -->
